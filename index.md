...
<div style="display: flex; justify-content: center; align-items: flex-start; gap: 10px; width:100%">
		<img src = "assets/arch_unity_carp.jpg" alt="capr motif" style="width:30%">
		<img src = "assets/arch_unity_center.jpg" alt ="center pattern" style="width:30%">
		<img src = "assets/arch_unity_dragons.jpg" alt ="dragons" style="width:30%">
</div>
