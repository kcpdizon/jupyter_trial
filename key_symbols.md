...
<div align="center">
    <div style="display: flex; gap: 10px; margin-bottom: 10px;">
        <img src="assets/arch_unity_carp.jpg" alt="carp motif" style="width: 33%; height: 180px; object-fit: cover; border-radius: 4px;">
        <img src="assets/arch_unity_center.jpg" alt="center pattern" style="width: 33%; height: 180px; object-fit: cover; border-radius: 4px;">
        <img src="assets/arch_unity_dragons.jpg" alt="Description 3" style="width: 33%; height: 180px; object-fit: cover; border-radius: 4px;">
    </div>
